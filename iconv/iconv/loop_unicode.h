...
static int unicode_transliterate (conv_t cd, ucs4_t wc, unsigned char* outptr, size_t outleft)
{
...
static void uc_to_mb_write_replacement (const char *buf, size_t buflen,void* callback_arg)
{
...
static void mb_to_uc_write_replacement (const unsigned int *buf, size_t buflen, void* callback_arg)
{
